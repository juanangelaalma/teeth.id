    ...
    <div>
        ...
        <div class="relative z-10">
          <div class="w-full relative bg-primary-light py-12 section-padding md:h-[250px] mx-auto flex">
            <div class="flex flex-col md:absolute w-full md:px-[7rem] top-[50%] md:translate-y-[-50%] md:left-[50%] md:translate-x-[-50%] max-w-[1600px] z-20">
              <h1 class="text-section-paragraph font-bold text-dark">Buat janji</h1>
              <p class="text-[16px] text-light-gray">Buat janji dengan dokter pilihan kamu jauh lebih mudah dan terpercaya</p>
              <form class="flex w-full flex-col md:flex-row my-8 space-y-3 md:space-y-0 rounded-md lg:overflow-hidden">
                ...
                <div class="relative marker:text-gray-600 flex-1 focus-within:text-gray-400">
                  ...
                  <input type="text" name="q" class="text-sm w-full py-3 border-none outline-none focus:border-transparent focus:ring-0 text-dark pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Semua lokasi" autocomplete="off">
                </div>
                ...
                <div class="relative marker:text-gray-600 flex-1 focus-within:text-gray-400">
                  <span class="absolute top-[50%] translate-y-[-50%] flex items-center pl-4">
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7.33301 13.3333C10.6467 13.3333 13.333 10.647 13.333 7.33334C13.333 4.01963 10.6467 1.33334 7.33301 1.33334C4.0193 1.33334 1.33301 4.01963 1.33301 7.33334C1.33301 10.647 4.0193 13.3333 7.33301 13.3333Z" stroke="#515559" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M15.9999 16L11.5732 11.5733" stroke="#515559" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                  </span>
                  <input type="text" name="q" class="text-sm w-full py-3 border-none pl-10 focus:outline-none focus:border-transparent focus:ring-0 focus:bg-white focus:text-gray-900" placeholder="Cari berdasarkan nama dokter" autocomplete="off">
                </div>
                <button type="submit" class="bg-primary py-2 px-7 text-white rounded-xl text-btn md:rounded-none cursor-pointer">Cari</button>
              </form>
            </div>
          </div>
          <img class="hidden md:block absolute top-0 right-0 h-full pr-[7rem]" src="{{ asset('assets/images/buat-janji.png') }}" alt="">
        </div>
