...
<a
    href="{{ route('user.articles.show', $slug) }}"
    class="w-full lg:mx-3 my-4 flex items-center py-2 px-4 lg:p-0 space-x-4 cursor-pointer lg:flex-col lg:w-[30%] transition-hover duration-300 hover:rounded-xl hover:shadow-card-article">
    <div
        class="w-[90px] h-[90px] min-w-[90px] min-h-[90px] lg:w-full lg:h-auto lg:min-w-[120px] lg:min-h-[120px] rounded-lg lg:rounded-2xl overflow-hidden">
        <img class="w-full object-cover object-center h-full" src="{{ $image }}" alt="">
    </div>
