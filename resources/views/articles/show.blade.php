            ...
            <div class="self-start w-full flex flex-col lg:w-1/4 mt-8 lg:mt-0 pl-0 items-center space-y-4 sticky top-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-row items-end justify-center space-x-2 text-dark-gray mx-auto">
                        ...
                        <p class="text-content-paragraph leading-none font-normal text-dark-gray">{{  $article->doctor->clinic ? $article->doctor->clinic->name : 'Belum diset' }}</p>
                    </div>
                    <div class="flex justify-center">
                        <div class="bg-primary-light px-3 py-1 rounded-xl">
                            <p class="text-sm text-light-gray"><span class="text-primary font-semibold">{{ $article->doctor->user->orders ? $article->doctor->user->orders()->count() : 0 }} pasien</span>
                                telah
                                membuat janji</p>
                        </div>
                    </div>
